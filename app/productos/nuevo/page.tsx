    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            const result = await crearProducto({
                ...
                // Nuevos campos obligatorios con valores por defecto
                ...
                impuesto_extra_2: 0,
                impuesto_extra_3: 0,
                precio_venta_final: formData.precio_unitario
            })
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Agregar producto al inventario</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    />
                                    <p className="mt-1 text-xs text-gray-500">Se generará alerta cuando el stock esté por debajo de este valor</p>
                                </div>
                            </div>
                        </div>
